...
- *Client Id* - Can be obtained through the [business portal](https://portal.vippsmobilepay.com).
- *Client Secret*- Can be obtained through the  [business portal](https://portal.vippsmobilepay.com).
- *Subscription Key* - Can be obtained through the  [business portal](https://portal.vippsmobilepay.com).
- *Serial number* - Your merchant Serial number, can be obtained through the  [business portal](https://portal.vippsmobilepay.com).
...
The package automatically appends the generated order ID as a query string to the specified URL. The quicksilver example implementation can be found [on GitHub](https://github.com/vippsas/vipps-episerver/blob/master/demo/Sources/EPiServer.Reference.Commerce.Site/Features/Checkout/Controllers/PaymentFallbackController.cs).
